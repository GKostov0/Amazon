...
namespace RPGCharacterAnims.Extensions
{
    ...
    public static class AnimatorExtensions
    {
		...
		public static void SetWeapons(this Animator animator, AnimatorWeapon animatorWeapon, int weaponSwitch, EWeapon leftWeapon, EWeapon rightWeapon, Side weaponSide)
		{
			...
			if (leftWeapon != EWeapon.Unarmed) { animator.SetInteger(AnimationParameters.LeftWeapon, ( int )leftWeapon); }
			if (rightWeapon != EWeapon.Unarmed) { animator.SetInteger(AnimationParameters.RightWeapon, ( int )rightWeapon); }
